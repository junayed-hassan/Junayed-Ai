    ...
    <div className="flex-1 pb-15vh relative">
      ...
      <div className="max-w-[900px] m-auto">
        ...
        <div className="max-w-[420px] mb-[5%] ">
          ...
          : <div className='result'>
              ...
              <div className='flex mt-3 mb-5'>
                ...
                : <p className='text-sm font-normal leading-7 ' dangerouslySetInnerHTML={{__html:resultData}}></p>
                }
        ...
        <div className='absolute bottom-0 w-full max-w-[900px] px-5 m-auto mb-5'>
          ...
          <p className='mx-auto text-center text-xs font-light mt-5'>Using Google Gemini API with React JS.   Junayed Ai is developed it is an Ai web, like Google Gemini or ChatGPT.</p>
        </div>
      </div>
    </div>
  )
